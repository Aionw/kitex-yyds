...
func (p *HelloThriftClient) Echo(ctx context.Context, req *Request) (r *Response, err error) {
	var _args HelloThriftEchoArgs
	_args.Req = req
	var _result HelloThriftEchoResult
...
func NewHelloThriftProcessor(handler HelloThrift) *HelloThriftProcessor {
	self := &HelloThriftProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self.AddToProcessorMap("echo", &helloThriftProcessorEcho{handler: handler})
	return self
}
...
type helloThriftProcessorEcho struct {
	handler HelloThrift
}

func (p *helloThriftProcessorEcho) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := HelloThriftEchoArgs{}
...
func (p *HelloThriftEchoArgs) GetReq() *Request {
	if !p.IsSetReq() {
		return HelloThriftEchoArgs_Req_DEFAULT
	}
	return p.Req
}
...
var fieldIDToName_HelloThriftEchoArgs = map[int16]string{
	1: "req",
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_HelloThriftEchoArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *HelloThriftEchoArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *HelloThriftEchoArgs) String() string {
	...
	return fmt.Sprintf("HelloThriftEchoArgs(%+v)", *p)
}
...
func (p *HelloThriftEchoResult) GetSuccess() *Response {
	if !p.IsSetSuccess() {
		return HelloThriftEchoResult_Success_DEFAULT
	}
	return p.Success
}
...
var fieldIDToName_HelloThriftEchoResult = map[int16]string{
	0: "success",
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_HelloThriftEchoResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *HelloThriftEchoResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *HelloThriftEchoResult) String() string {
	...
	return fmt.Sprintf("HelloThriftEchoResult(%+v)", *p)
}
